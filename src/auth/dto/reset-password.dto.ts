...
export class ResetPasswordDto {
     ...
     */
    @ApiProperty({ description: 'Token đặt lại mật khẩu nhận được từ email.', example: 'a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4' })
     ...
     */
    @ApiProperty({ description: 'Mật khẩu mới (tối thiểu 8 ký tự).', example: 'newStrongPassword123' })
