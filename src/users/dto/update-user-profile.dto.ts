...
import { IsString, IsOptional, IsPhoneNumber, IsIn, MaxLength, MinLength } from 'class-validator';
...
export class UpdateUserProfileDto {
    ...
    @IsOptional()
    @IsIn(['male', 'female', 'other'], { message: 'Giới tính phải là một trong các giá trị: male, female, other.' })
    gender?: string;
