...
CREATE DATABASE IF NOT EXISTS football_booking_system CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE roles (
    ...
    name VARCHAR(50) NOT NULL UNIQUE COMMENT 'Tên vai trò (e.g., admin, user, field_owner)'
...
CREATE TABLE accounts (
    ...
    password_hash VARCHAR(255) NULL COMMENT 'NULL nếu đăng nhập qua social provider',
...
CREATE TABLE cities (
    ...
    type VARCHAR(50) NOT NULL COMMENT 'e.g., Tỉnh, Thành phố'
);
...
CREATE TABLE wards (
    id INT PRIMARY KEY,
    name VARCHAR(100) NOT NULL,
    type VARCHAR(50) NOT NULL COMMENT 'e.g., Phường, Xã, Thị trấn',
...
ALTER TABLE user_profiles ADD COLUMN address_id VARCHAR(36) NULL;
...
CREATE TABLE fields (
    ...
    description TEXT NULL,
    status VARCHAR(20) NOT NULL DEFAULT 'active' COMMENT 'e.g., active, inactive, under_maintenance',
...
CREATE TABLE bookings (
    ...
    status VARCHAR(20) NOT NULL DEFAULT 'pending' COMMENT 'e.g., pending, confirmed, completed, cancelled',
    ...
    INDEX idx_bookings_user_profile_id (user_profile_id),
...
CREATE TABLE payments (
    ...
    status VARCHAR(20) NOT NULL DEFAULT 'pending' COMMENT 'e.g., pending, completed, failed',
    payment_method VARCHAR(50) NOT NULL COMMENT 'e.g., cash, momo, vnpay',
...
CREATE TABLE feedbacks (
    ...
    FOREIGN KEY (submitter_id) REFERENCES user_profiles(id),
    ...
    INDEX idx_feedbacks_assignee_id (assignee_id)
);
